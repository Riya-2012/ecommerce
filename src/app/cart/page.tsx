...
const [shippingForm ,setShippingForm]=useState<shippingFormInputs>()
  return (
    <div className='flex flex-col gap-0 items-center justify-center mt-12'>
        <h1 className='text-2xl font-medium pb-4 '>Your Shoppping Cart</h1>
...
: activeStep===2 ?  <ShippingForm setShippingForm={setShippingForm} />: activeStep=== 3 && shippingForm ? (<Payment/>):(
...
{ activeStep===1 &&
    <button onClick={()=> router.push("/cart?step=2", {scroll:false})} className='w-full bg-gray-800 hover:bg-gray-900 transition-all duration-300 text-white p-2 rounded-lg cursor-pointer flex justify-center items-center'>Continue <ArrowRight className='w-4 h-4 '/></button>
}
